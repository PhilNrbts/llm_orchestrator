...
class ParallelQueryTool(BaseTool):
    ...
    def execute(self, **kwargs) -> Dict[str, Any]:
        ...
        def execute_single_query(query_config: Dict[str, Any]) -> Dict[str, Any]:
            ...
            try:
                ...
                model_call_params = {
                    ...
                    'prompt': query_config['prompt_template'],  # Note: template resolution happens in executor
                ...
                console.print(f"❌ Query failed for {query_config.get('provider', 'unknown')}/{query_config.get('model', 'unknown')}: {str(e)}", style="red")
                return {
        ...
        with concurrent.futures.ThreadPoolExecutor(max_workers=max_workers) as executor:
            ...
            for future in concurrent.futures.as_completed(future_to_query):
                ...
                try:
                    ...
                    console.print(f"✅ Query {query_index + 1}/{len(queries)} completed", style="green")
                except Exception as e:
                    console.print(f"❌ Query {query_index + 1} failed: {str(e)}", style="red")
        ...
        console.print(f"🎉 All {len(queries)} parallel queries completed", style="bold green")
